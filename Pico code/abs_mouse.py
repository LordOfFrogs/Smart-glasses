...
* Author(s): David Glaude, Neradoc, Modified by Tori Dell.
...
class Mouse:
    ...
    def move(self, x=0, y=0, wheel=0):
        ...
        # Coordinates
        self.x_pos = self._limit_coord(x)
        self.y_pos = self._limit_coord(y)
        # HID reports use little endian
        self.report[1:5] = struct.pack("<HH", self.x_pos, self.y_pos)
        self._mouse_device.send_report(self.report)
