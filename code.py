...
hall1_hist = [True, True, True, True, True]
hall2_hist = [True, True, True, True, True]
hall3_hist = [True, True, True, True, True]
hall4_hist = [True, True, True, True, True]
...
def UpdateHistoryLists(hall1, hall2, hall3, hall4):
  for i in range(CLICK_DELAY_MS//SAMPLERATE_DELAY_MS, 1, -1):
...
while True:
  ...
  if (
    ...
    (not hall1_prev and hall2_prev and hall3_prev and hall4_prev)
  ):
    m.press(Mouse.LEFT_BUTTON)
    ClearHistoryLists()
  elif (
    (not hall1 and hall2 and hall3 and hall4) and
    ...
    (hall1 and hall2 and hall3 and hall4) and
    (not hall1_prev and not hall2_prev and hall3_prev and hall4_prev)
  ):
    m.press(Mouse.RIGHT_BUTTON)
    ClearHistoryLists()
  elif (
    (not hall1 and not hall2 and hall3 and hall4) and
    (hall1_prev and hall2_prev and hall3_prev and hall4_prev)
  ):
